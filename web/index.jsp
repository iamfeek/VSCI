                    ...
                    <div class="col-sm-12 text-center">
                        <div class="panel panel-default slideInLeft animate">
                            ...
                            <div class="panel-body">
                                <p><b>50Gb</b> of free storage for your files. All encrypted and only visible by you.</p>
                                <hr>GO
                                <hr>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="panel panel-default slideInRight animate">
                            ...
                            <div class="panel-body">
                                <p>If whispering to one's ear is the safest way to tell a <strong>secret</strong>, this would be after it.</p>
                                <hr>GO
                                <hr>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <div class="row">
                ...
                And you have now become a zombie in their eyes.</div>
            </div>
            <br>
            <p class="text-center">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <form class="col-md-10 col-md-offset-1 col-xs-12 col-xs-offset-0" method="post" action="main">
