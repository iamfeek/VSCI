...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="//cdn.jsdelivr.net/bootstrap.metismenu/1.1.2/css/metismenu.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="//cdn.jsdelivr.net/morris.js/0.5.1/morris.css" rel="stylesheet">
...
<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/metisMenu/2.0.0/metisMenu.min.js"></script>
